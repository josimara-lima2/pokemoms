...
function Copyright(props: any) {
  return (
    ...
    >
      {"Copyright © "}
      <Link color="inherit" href="https://pokeapi.co/">
        Pokemons
      </Link>{" "}
...
function DashboardContent() {
  ...
  const handleClick = () => {
    ...
    if (!checked === true) {
      ...
      mdTheme.palette.mode = "light";
    }
  };

  const backgroundTema = () =>
      ...
      <Box sx={{ display: "flex" }}>
        ...
        <AppBar position="absolute" open={open}>
          ...
          >
            ...
            {/* Alterando tema da tela */}

            <IconButton
              onClick={handleClick}
              sx={{
                color: (theme) =>
                  theme.palette.mode === "light" ? "#4a148c" : "#FFF",
              }}
            >
              <DarkModeIcon />
            </IconButton>
          ...
          <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} md={8} lg={9}>
                <Paper
                  sx={{
                    backgroundColor: backgroundTema(),
                    p: 2,
                    display: "flex",
